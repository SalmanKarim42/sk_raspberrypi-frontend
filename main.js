...
function hangup(roomID) {
  socket.emit('hangupclient', roomID);
  join(roomID);
}
        ...
        <View style={styles.footerButtons}>
          {
            ...
            }} onPress={() => { hangup(this.state.roomID) }}>
              <Text style={{ color: 'white', fontSize: 16, fontWeight: '700' }}>Hangup</Text>
            </TouchableHighlight>
          }
        </View>
      </View>
